...
| # | Item | Owner | State |
|---|---|---|---|
| 1 | The precondition drive of 17.2, added to `test/swipe-navstack-settle.test.js` as a second `NAVAPPLIES` newNav cell, shown red under `NAVFWDCLEAR-a` with the existing newNav drive green in the same run | the test author | owed |
