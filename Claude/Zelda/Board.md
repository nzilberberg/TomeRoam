...
- **NEXT ACTION — the test author** (§13 step 9a) for the `NAVAPPLIES` abort-token clause, then the
  builder (9b) for that plus F2/F3/F4 and O1, then the coverage auditor.
