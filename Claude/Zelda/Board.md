...
| T-S7A | Swipe stage 7 (the Browse lease boundary) — plan filed, tempered | the planner | TEMPER 2026-08-06 (round 1): scope determination HELD (8 of 10 inheritance rows re-derived independently); 3 Structural, 2 Weak, 3 Note; F1-F4 ruled | the planner amends for the three Structural findings, then re-files for round 2 | none | `Claude/Charpy/PLAN-swipe-stage7-2026-08-06-r1.md` |
