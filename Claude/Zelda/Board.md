...
- **NEXT ACTION — the builder**, on the delta review's F1/F2/F3, THEN the coverage auditor. Taken in
  that order because F3 edits the test file, which is the auditor's own surface — auditing first
  would mean auditing an artifact about to change.
