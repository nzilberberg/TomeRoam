...
- **NEXT ACTION — round 1 plan review of `PLAN-swipe-navstack-settle-window.md` (`T-S7M`)**, the
  settle-window nav-stack defect in SHIPPED code, taken ahead of §17 step 3 because it is live
  user-facing breakage while stage 7 is an unbuilt refactor. Ruled **standalone, landing BEFORE
  stage 7** — ⚠️ so it changes the source stage 7's own measurements were taken against, and stage 7
  must re-measure after it lands.
